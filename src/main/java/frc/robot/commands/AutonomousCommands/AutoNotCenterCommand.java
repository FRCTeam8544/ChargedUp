...
public class AutoNotCenterCommand extends SequentialCommandGroup{
  ...
  public AutoNotCenterCommand(DrivetrainSubsystem ar_drivetrain, ArmSubsystem ar_ArmSubsystem, WristSubsystem ar_wristSubsystem, ArmPneumaticsSubsystem a_pneumatics, ArmExtenderSubsystem a_extender, WristGoBRRR wheelCommand) {
    ...
    addCommands(//time removed check not center for original
      new SequentialCommandGroup(
        ...
        new ParallelCommandGroup(
          ...
          new DriveAndBalance(ar_drivetrain, true, false, 70) 
        ) 
      )
        /*new ParallelCommandGroup(
